...
public class Fragment_Historial extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView AccionUsuario = view.findViewById(R.id.txtActionUser);
        //aqui se muestran las interacciones del usuario con la aplicación
        AccionUsuario.setText("Usuario creado");
    }
    }